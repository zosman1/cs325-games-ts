...
class MyScene extends Phaser.Scene {
    ...
    update() {
        ...
        this.bouncy.rotation = this.physics.accelerateToObject(
            this.bouncy,
            this.input.activePointer.positionToCamera(this.cameras.main as Phaser.Cameras.Scene2D.Camera) as Phaser.GameObjects.GameObject, //from docs, "can be any object but must have visible x-y coords"
            500, 500, 500
            );
    }
}
