...
export class Button extends Phaser.GameObjects.Sprite {
  ...
  constructor(scene: Phaser.Scene, x: number, y: number, texture: string | Phaser.Textures.Texture, actionOnClick = () => {}, context: any, overFrame: string | number, outFrame: string | number, downFrame: string | number) {
